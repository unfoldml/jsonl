...
-- conduit
import qualified Conduit as C (ConduitT, runConduit, sourceFile, sinkFile, await, yield, yieldMany, mapC, unfoldC, foldMapC, foldlC)
...
data Record = R String String Int Bool deriving (Eq, Generic)
